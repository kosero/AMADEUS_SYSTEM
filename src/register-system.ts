...
class RegisterSystem {
    ...
    async sayHello(channel: TextChannel) {
        await channel.send(`Hos geldin <@${this.member.id}>, sunucuya katildigin icin tesekkurler, diger kanallari gorebilmen icin seninle biraz sohbet etmem gerekiyor, cok bekletmem.`);
    }
}
